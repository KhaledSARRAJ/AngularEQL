...
export class PokemonFormComponent implements OnInit {
  ...
  // Détermine si le type passé en paramètres appartient ou non au pokémon en cours
  ...
  // Méthode appelée lorsque l'utilisateur ajoute ou retire un type au pokémon en cours
